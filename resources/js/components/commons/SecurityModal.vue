<template>
    <div>
        <div class="modal fade" id="showSecurityModal">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    
                    <div class="modal-header">
                        <h4 class="modal-title">{{ $t('security_list') }}</h4>
...
export default {
    name: 'VendorPaymentProvideModal',
    components: { 
        VueDatePicker 
    },
    props: {
	...
	data() {
		return {
            ...
            submitLoading: false,
            addAnother: false,
            disabledVendorSelection: false,

            form: {
				id: '',
				date_time: moment().format('YYYY-MM-DD'),
				account_id: '',
				payment_type: 'received_money',
				voucher_number: '',
				amount: 0,
				note: '',
            ...
            validationErrors: {},
            paymentTypes: [
                { name: 'received_money', value: 'received_money' },
                // { name: 'paid_money', value: 'paid_money' },
            ]
		}
	},
    created() {
	...
	methods: {
        add(){
            ...
            axios
                .post(this.apiLinkQuery, this.form)
                .then((response) => {

                    if(!this.addAnother){
                        // this.resetForm();
						$("#showSecurityModal").modal("hide");
					}
        ...
        resetForm(){
            ...
            this.form.payment_type = 'received_money';
            ...
            this.disabledVendorSelection = false;
            this.apiLink = '';
        },
	},
    computed: {
