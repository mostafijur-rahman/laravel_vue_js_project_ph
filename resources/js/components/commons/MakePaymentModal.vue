<template>
    <div>
        <div class="modal fade" id="showMakePaymentModal">
                                ...
                                <div class="col-md-4"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select 
                                            ...
                                            <option v-if="(accounts.length > 0) && $store.state.auth.user.company.payment_feature == 'enable'" v-for="account in accounts" :value="account.id">{{ account.user_name }} ({{ account.balance }})</option>
                                        </select>
                                        <span
                                            class="error invalid-feedback"
        ...
        add(){
            ...
            axios
                ...
                .then((response) => {
                    ...
                    if(!this.addAnother){
                        this.resetForm();
						$("#showMakePaymentModal").modal("hide");
					}
