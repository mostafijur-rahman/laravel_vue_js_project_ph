<template>
    <div>
        <div class="modal fade" id="showVendorPaymentProvideModal">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    
                    <div class="modal-header">
                        <h4 class="modal-title">{{ $t('list_of_payments_receipts_to_vehicle_supplier') }}</h4>
        ...
        add(){
            ...
            axios
                ...
                .then((response) => {
                    ...
                    if(!this.addAnother){
                        // this.resetForm();
						$("#showVendorPaymentProvideModal").modal("hide");
					}
