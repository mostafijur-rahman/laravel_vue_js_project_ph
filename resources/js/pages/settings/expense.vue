...
export default {
	...
	methods: {
		...
		getData() {
			...
			axios.get('/api/settings/expenses', { params })
				.then((response) => {
		...
		createData() {
			...
			this.loading = true;
			// insertion
			axios.post('/api/settings/expenses', this.form)
				.then((response) => {
		...
		updateData() {
			...
			this.loading = true;
			// insertion
			axios.put('/api/settings/expenses/' + this.form.id, this.form)
				.then((response) => {
		...
		async destroy(id, index) {
			try {
				...
				// fire request
				let response = await axios.delete('/api/settings/expenses/' + id);
