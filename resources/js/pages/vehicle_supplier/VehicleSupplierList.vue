	...
	methods: {
		...
		showVendorModal(indexId = null, list = null){
			...
			if(list){
				...
				this.$refs.vRef.form.previous_loan = list.previous_loan?list.previous_loan:0;
				this.$refs.vRef.form.loan_date = list.loan_date?list.loan_date:'';

				this.$refs.vRef.form.previous_advance = list.previous_advance?list.previous_advance:0;
				this.$refs.vRef.form.advance_date = list.advance_date?list.advance_date:'';
			}
			this.$refs.vRef.form.type = 'vehicle_supplier';
		...
		setSearchFilterParams(params){
			...
			this.filterParams.type = 'vehicle_supplier';
			this.lists = {};
			this.getData();
		},
