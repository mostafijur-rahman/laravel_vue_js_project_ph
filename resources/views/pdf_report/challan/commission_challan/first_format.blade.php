			...
			<div class="invoice-box">
				<table class="table-design" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td class="center" width="10%">@lang('cmn.supplier')</td>
                        <td class="center" width="10%">@lang('cmn.contract_rent')</td>
						<td class="center" width="10%">@lang('cmn.paid')</td>
                        <td class="center" width="10%">@lang('cmn.challan_due')</td>s


                        <td class="center" width="10%">@lang('cmn.company')</td>
                        <td class="center" width="10%">@lang('cmn.contract_rent')</td>
						<td class="center" width="10%">@lang('cmn.received')</td>
                        <td class="center" width="10%">@lang('cmn.challan_due')</td>s
                    ...
                    @if(count($lists) > 0)
                        ...
                        @php 
							$sum_vendor_bills = 0; 
							$sum_vendor_payments = 0; 
							$sum_vendor_challan_due = 0; 
                        ...
                        @foreach($lists as $key => $list)
                            ...
                            @php 
                                $sum_vendor_bills += $list->total_vendor_bills; 
                                $sum_vendor_payments += $list->total_vendor_payments; 
                                $sum_vendor_challan_due += $list->total_vendor_challan_due; 
                            ...
                            <tr class="item">
                                ...
                                <td class="center">{{ $list->rental_vehicle ? $list->rental_vehicle->vendor->name : '---' }}</td>
                                <td class="center">{{ number_format($list->total_vendor_bills) }}</td>
                                <td class="center">{{ number_format($list->total_vendor_payments) }}</td>
                                <td class="center">{{ number_format($list->total_vendor_challan_due) }}</td>
                                ...
                                <td class="center">{{ number_format($list->balance) }}</td>
                            </tr>
                        @endforeach
                            <tr>
                                <td class="text-right" colspan="4"><b style="font-weight: bold;">@lang('cmn.total') = </b></td>
                                
                                <td class="center"><b style="font-weight: bold;">{{ number_format($sum_vendor_bills) }}</b></td>
                                <td class="center"><b style="font-weight: bold;">{{ number_format($sum_vendor_payments) }}</b></td>
                                <td class="center"><b style="font-weight: bold;">{{ number_format($sum_vendor_challan_due) }}</b></td>
